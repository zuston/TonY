...
public class Utils {
   ...
   */
  public static boolean parseDockerConfigs(Configuration tonyConf, Map<String, String> containerEnv, String jobName) {
    if (tonyConf.getBoolean(TonyConfigurationKeys.DOCKER_ENABLED, TonyConfigurationKeys.DEFAULT_DOCKER_ENABLED)) {
      ...
      if (tonyConf.get(TonyConfigurationKeys.getDockerImageKey(Constants.AM_NAME)) != null) {
        imagePath = tonyConf.get(TonyConfigurationKeys.getDockerImageKey(jobName));
      }
      if (imagePath == null) {
